...
/// * [number] 
@BuiltValue()
abstract class StudentDto implements Built<StudentDto, StudentDtoBuilder> {
  ...
  factory StudentDto([void updates(StudentDtoBuilder b)]) = _$StudentDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StudentDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StudentDto> get serializer => _$StudentDtoSerializer();
}

class _$StudentDtoSerializer implements PrimitiveSerializer<StudentDto> {
  @override
  final Iterable<Type> types = const [StudentDto, _$StudentDto];

  @override
  final String wireName = r'StudentDto';
  ...
  void _deserializeProperties(
    ...
    required StudentDtoBuilder result,
  ...
  @override
  StudentDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StudentDtoBuilder();
